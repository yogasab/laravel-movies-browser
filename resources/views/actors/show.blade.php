...
@section('content')
  <div class="actor border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
      {{-- Social Media --}}
      <div class="flex-none">
        <img src="{{ $actor['profile_path'] }}" alt="Actors" class="w-64 shadow rounded md:w-80">
        <ul class="flex items-center mt-4">
          ...
          @if ($social['twitter'])
            <li>
              <a href="{{ $social['twitter'] }}" title="Twitter">
                <svg class="fill-current text-gray-400 hover:text-white w-6 ml-3" viewBox="0 0 512 512">
          ...
          @if ($social['instagram'])
            <li>
              <a href="{{ $social['instagram'] }}" title="Instagram">
                <svg class="fill-current text-gray-400 hover:text-white w-6 ml-3" viewBox="0 0 448 512">
          ...
          @if ($actor['homepage'])
            <li>
              <a href="{{ $actor['homepage'] }}" title="Instagram">
                <svg class="fill-current text-gray-400 hover:text-white w-6 ml-3" viewBox="0 0 496 512">
    ...
    {{-- End Social Media --}}
      ...
      <div class="md:ml-24">
        {{-- Details Actor --}}
          <h2 class="text-5xl font-semibold mb-2">{{ $actor['name'] }}</h2>
          <div class="flex items-center text-gray-400 mt-1">
            ...
            <span class="ml-2 mt-1 text-md text-muted">
          ...
          <div class="mt-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
              @foreach ($knownForMovies as $movieCast)
                <div class="mt-4">
                  <a href="{{ $movieCast['link_to_page'] }}">
                    <img src="{{ $movieCast['poster_path'] }}" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150">
                  </a>
      ...
      <ul class="list-disc leading-loose pl-5 mt-8">
        @foreach ($credits as $credit)
          <li>
            ...
            <strong><a class="hover:underline">{{ $credit['title'] }}</a></strong>
            @if ($credit['character'])
              as {{ $credit['character'] }}
            @endif
          </li>
